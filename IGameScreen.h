/*
// the interface for a screen,
// one of our game screens
*/
#pragma once
...
namespace Adina{
	...
	////==================================================================================
	////==================================================================================
	/// Different state that a screen can have
    ...
    public:
		...
		virtual void update(float deltaTim) = 0;
        virtual void draw() = 0;
    ...
    protected:
        ...
        IMainGame* m_game = nullptr;  /// The mainGame own the screen
        int m_screenIndex = -1;
    };
	////==================================================================================
	////==================================================================================
